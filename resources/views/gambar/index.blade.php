...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">List Gambar</h4>
        </div>
    </div>
</div>
@endsection
...
<div class="col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-body table-responsive">
            <a href="{{ url('/gambar/create') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Tambah File</a>
            <h5 class="header-title">Data Gambar</h5>
            <div class="">
                <table id="datatable2" class="table">
                    ...
                    <tr>
                        <td><img src="{{ url('berkasnya/gambar/'.$value->file) }}" height="100px" width="100px"></td>
                        <td>{{$value->jenis}}</td>
                        <td>
                            <button type="button" class="btn btn-sm btn-danger delete" data-id="{{ $value->id }}" data-file="{{$value->id}}"><i class="fa fa-trash"></i> Hapus</button>
                                {{ Form::open(['url'=>route('gambar.destroy', [Crypt::encrypt($value->id)]), 'method'=>'delete', 'id' => $value->id, 'style' => 'display: none;']) }}
                                {{ csrf_field() }}
                                {{ Form::close() }}
                        </td>
                    </tr>
