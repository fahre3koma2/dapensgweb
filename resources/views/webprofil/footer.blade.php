<footer class="main-footer">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                            <div class="footer-widget logo-widget">
                                <div class="logo">
                                    <a href="index.html"><img src="{{ url('webprofil/images/footer-logo.png')}}" alt="" /></a>
                                </div>
                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <a href="tel:+623139844924">(031)-39844924</a>
                                    </li>
                                    <li>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="copyright">Copyright 2021, Dana Pensiun Semen Gresik. All Rights Reserved.</div>
        </div>
    </div>
</footer>
